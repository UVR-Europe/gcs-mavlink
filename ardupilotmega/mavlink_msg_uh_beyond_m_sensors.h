...
typedef struct __mavlink_uh_beyond_m_sensors_t {
 ...
 float pressure_frame; /*<  Frame pressure*/
...
#define MAVLINK_MSG_ID_UH_BEYOND_M_SENSORS_LEN 66
#define MAVLINK_MSG_ID_UH_BEYOND_M_SENSORS_MIN_LEN 66
#define MAVLINK_MSG_ID_15007_LEN 66
#define MAVLINK_MSG_ID_15007_MIN_LEN 66

#define MAVLINK_MSG_ID_UH_BEYOND_M_SENSORS_CRC 135
#define MAVLINK_MSG_ID_15007_CRC 135
...
#define MAVLINK_MESSAGE_INFO_UH_BEYOND_M_SENSORS { \
    ...
    {  { "temperature_EG1", NULL, MAVLINK_TYPE_FLOAT, 0, 0, offsetof(mavlink_uh_beyond_m_sensors_t, temperature_EG1) }, \
         ...
         { "pressure_frame", NULL, MAVLINK_TYPE_FLOAT, 0, 52, offsetof(mavlink_uh_beyond_m_sensors_t, pressure_frame) }, \
         { "rotor_rpm", NULL, MAVLINK_TYPE_INT16_T, 0, 60, offsetof(mavlink_uh_beyond_m_sensors_t, rotor_rpm) }, \
         { "engine_rpm", NULL, MAVLINK_TYPE_INT16_T, 0, 62, offsetof(mavlink_uh_beyond_m_sensors_t, engine_rpm) }, \
         { "battery_12v", NULL, MAVLINK_TYPE_FLOAT, 0, 56, offsetof(mavlink_uh_beyond_m_sensors_t, battery_12v) }, \
         { "status_bits", NULL, MAVLINK_TYPE_UINT16_T, 0, 64, offsetof(mavlink_uh_beyond_m_sensors_t, status_bits) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_UH_BEYOND_M_SENSORS { \
 ...
 * @param pressure_frame  Frame pressure
                               ...
                               float temperature_EG1, float temperature_EG2, float temperature_EG3, float temperature_EG4, float temperature_CHT1, float temperature_CHT2, float temperature_oil, float temperature_coolant, float temperature_gearbox, float pressure_fuel, float pressure_oil, float pressure_manifold, float level_fuel, float pressure_frame, int16_t rotor_rpm, int16_t engine_rpm, float battery_12v, uint16_t status_bits)
{
    ...
    _mav_put_float(buf, 52, pressure_frame);
    _mav_put_float(buf, 56, battery_12v);
    _mav_put_int16_t(buf, 60, rotor_rpm);
    _mav_put_int16_t(buf, 62, engine_rpm);
    _mav_put_uint16_t(buf, 64, status_bits);
    ...
    packet.pressure_frame = pressure_frame;
...
{
    return mavlink_msg_uh_beyond_m_sensors_pack(system_id, component_id, msg, uh_beyond_m_sensors->temperature_EG1, uh_beyond_m_sensors->temperature_EG2, uh_beyond_m_sensors->temperature_EG3, uh_beyond_m_sensors->temperature_EG4, uh_beyond_m_sensors->temperature_CHT1, uh_beyond_m_sensors->temperature_CHT2, uh_beyond_m_sensors->temperature_oil, uh_beyond_m_sensors->temperature_coolant, uh_beyond_m_sensors->temperature_gearbox, uh_beyond_m_sensors->pressure_fuel, uh_beyond_m_sensors->pressure_oil, uh_beyond_m_sensors->pressure_manifold, uh_beyond_m_sensors->level_fuel, uh_beyond_m_sensors->pressure_frame, uh_beyond_m_sensors->rotor_rpm, uh_beyond_m_sensors->engine_rpm, uh_beyond_m_sensors->battery_12v, uh_beyond_m_sensors->status_bits);
}
...
/**
 * @brief Get field pressure_frame from uh_beyond_m_sensors message
 *
 * @return  Frame pressure
 */
static inline float mavlink_msg_uh_beyond_m_sensors_get_pressure_frame(const mavlink_message_t* msg)
{
...
static inline void mavlink_msg_uh_beyond_m_sensors_decode(const mavlink_message_t* msg, mavlink_uh_beyond_m_sensors_t* uh_beyond_m_sensors)
{
    ...
    uh_beyond_m_sensors->pressure_frame = mavlink_msg_uh_beyond_m_sensors_get_pressure_frame(msg);
