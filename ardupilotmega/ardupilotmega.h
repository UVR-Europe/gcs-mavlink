...
#define MAVLINK_ARDUPILOTMEGA_XML_HASH 2574416706317008874
...
typedef enum MAV_CMD
{
   ...
   MAV_CMD_UVR_STARTER_ON=45001, /* Command to on the starter |Empty| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
   MAV_CMD_UVR_CLUTCH_ON_OFF=45002, /* Command to on/off the clutch |0: nothing, 1: on, 2: off| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
   ...
   MAV_CMD_UVR_TIMER_WRITE=45007, /* Command to on/off payload power |Timer number| Timer last time| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
   MAV_CMD_UVR_SET_PWM_OUT=45008, /* Sets control over SERVOx PWM output (rc_gcs_1(2) function have to be set for SERVOx) |Function index| PWM value in case of gcs source (see RC_GCSx_PWM_SRC)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
   MAV_CMD_ENUM_END=45009, /*  | */
} MAV_CMD;
#endif
...
/** @brief EASA Commands. */
#ifndef HAVE_ENUM_UH_EASA_CMD
#define HAVE_ENUM_UH_EASA_CMD
typedef enum UH_EASA_CMD
{
   UH_EASA_GET_PILOT_LIST=0, /*  | */
   UH_EASA_SAVE_PILOT=1, /*  | */
   UH_EASA_AUTHENTICATE=2, /*  | */
   UH_EASA_GET_CURRENT_PILOT=3, /*  | */
   UH_EASA_ERASE_PILOT=4, /*  | */
   UH_EASA_SN_GET=5, /*  | */
   UH_EASA_SN_SET=6, /*  | */
   UH_EASA_UNAUTHENTICATE=7, /*  | */
   UH_EASA_CMD_ENUM_END=8, /*  | */
} UH_EASA_CMD;
#endif

/** @brief EASA Command Status */
#ifndef HAVE_ENUM_UH_EASA_CMD_STATUS
#define HAVE_ENUM_UH_EASA_CMD_STATUS
typedef enum UH_EASA_CMD_STATUS
{
   UH_EASA_CMD_STATUS_OK=0, /*  | */
   UH_EASA_CMD_STATUS_WRONG_PILOT_INDEX=1, /*  | */
   UH_EASA_CMD_STATUS_SANITY_FAILED=2, /*  | */
   UH_EASA_CMD_STATUS_WRONG_SUM=3, /*  | */
   UH_EASA_CMD_STATUS_WRONG_PILOT_SECRET=4, /*  | */
   UH_EASA_CMD_STATUS_AUTH_FAILED=5, /*  | */
   UH_EASA_CMD_STATUS_SAVE_DENIED=6, /*  | */
   UH_EASA_CMD_STATUS_SAVE_FAILED=7, /*  | */
   UH_EASA_CMD_STATUS_LOAD_FAILED=8, /*  | */
   UH_EASA_CMD_STATUS_ENUM_END=9, /*  | */
} UH_EASA_CMD_STATUS;
#endif
...
#include "./mavlink_msg_uvr_engine_low_rate.h"
#include "./mavlink_msg_uvr_battery.h"
#include "./mavlink_msg_uvr_main_board.h"
#include "./mavlink_msg_uvr_ers_board.h"
#include "./mavlink_msg_uvr_esc_status.h"
#include "./mavlink_msg_uvr_pid_gov.h"
#include "./mavlink_msg_uh_beyond_m_sensors.h"
#include "./mavlink_msg_uvr_pilot_id.h"
#include "./mavlink_msg_uvr_generic_data.h"
#include "./mavlink_msg_uh_easa_pilot_request.h"
#include "./mavlink_msg_uh_easa_pilot_response.h"
#include "./mavlink_msg_uh_easa_uas_sn_request.h"
#include "./mavlink_msg_uh_easa_uas_sn_response.h"
#include "./mavlink_msg_uvr_generic_data_16.h"
#include "./mavlink_msg_uh_turbine_inspection.h"
#include "./mavlink_msg_rotor_sensors.h"
#include "./mavlink_msg_electric_motor_sensors.h"
#include "./mavlink_msg_power_board_info.h"
