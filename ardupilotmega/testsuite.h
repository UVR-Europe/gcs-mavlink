...
static void mavlink_test_uvr_pid_gov(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_uvr_pid_gov_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.gov_pid_out = packet_in.gov_pid_out;
        packet1.gov_pid_P_out = packet_in.gov_pid_P_out;
        packet1.gov_pid_I_out = packet_in.gov_pid_I_out;
        packet1.gov_pid_D_out = packet_in.gov_pid_D_out;
    ...
    mavlink_msg_uvr_pid_gov_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_uvr_pid_gov_pack(system_id, component_id, &msg , packet1.gov_pid_out , packet1.gov_pid_P_out , packet1.gov_pid_I_out , packet1.gov_pid_D_out );
    mavlink_msg_uvr_pid_gov_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_uvr_pid_gov_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.gov_pid_out , packet1.gov_pid_P_out , packet1.gov_pid_I_out , packet1.gov_pid_D_out );
    mavlink_msg_uvr_pid_gov_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_uvr_pid_gov_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_uvr_pid_gov_send(MAVLINK_COMM_1 , packet1.gov_pid_out , packet1.gov_pid_P_out , packet1.gov_pid_I_out , packet1.gov_pid_D_out );
    mavlink_msg_uvr_pid_gov_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
