...
static void mavlink_test_uvr_engine_low_rate(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_UVR_ENGINE_LOW_RATE >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
    ...
    mavlink_uvr_engine_low_rate_t packet_in = {
        17.0,45.0,73.0,101.0,129.0,157.0,185.0,213.0,241.0,269.0,297.0,325.0,353.0,381.0,963500376,20355,63,130
    };
    mavlink_uvr_engine_low_rate_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.oil_temperature_1 = packet_in.oil_temperature_1;
        packet1.oil_pressure_1 = packet_in.oil_pressure_1;
        packet1.oil_temperature_2 = packet_in.oil_temperature_2;
        packet1.oil_pressure_2 = packet_in.oil_pressure_2;
        packet1.head1_temperature = packet_in.head1_temperature;
        packet1.head2_temperature = packet_in.head2_temperature;
        packet1.turbine_pressure = packet_in.turbine_pressure;
        packet1.fuel_pressure = packet_in.fuel_pressure;
        packet1.exhaust_temperature_1 = packet_in.exhaust_temperature_1;
        packet1.exhaust_temperature_2 = packet_in.exhaust_temperature_2;
        packet1.exhaust_temperature_3 = packet_in.exhaust_temperature_3;
        ...
        packet1.rotor_sensors_state_flags = packet_in.rotor_sensors_state_flags;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_UVR_ENGINE_LOW_RATE_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_UVR_ENGINE_LOW_RATE_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_uvr_engine_low_rate_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_uvr_engine_low_rate_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_uvr_engine_low_rate_pack(system_id, component_id, &msg , packet1.oil_temperature_1 , packet1.oil_pressure_1 , packet1.oil_temperature_2 , packet1.oil_pressure_2 , packet1.head1_temperature , packet1.head2_temperature , packet1.turbine_pressure , packet1.fuel_pressure , packet1.exhaust_temperature_1 , packet1.exhaust_temperature_2 , packet1.exhaust_temperature_3 , packet1.exhaust_temperature_4 , packet1.coolant_temperature , packet1.turbine_state_flags , packet1.clutch_state_flags , packet1.frame_pressure , packet1.equipment_state_flags , packet1.rotor_sensors_state_flags );
    mavlink_msg_uvr_engine_low_rate_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_uvr_engine_low_rate_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.oil_temperature_1 , packet1.oil_pressure_1 , packet1.oil_temperature_2 , packet1.oil_pressure_2 , packet1.head1_temperature , packet1.head2_temperature , packet1.turbine_pressure , packet1.fuel_pressure , packet1.exhaust_temperature_1 , packet1.exhaust_temperature_2 , packet1.exhaust_temperature_3 , packet1.exhaust_temperature_4 , packet1.coolant_temperature , packet1.turbine_state_flags , packet1.clutch_state_flags , packet1.frame_pressure , packet1.equipment_state_flags , packet1.rotor_sensors_state_flags );
    mavlink_msg_uvr_engine_low_rate_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_uvr_engine_low_rate_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_uvr_engine_low_rate_send(MAVLINK_COMM_1 , packet1.oil_temperature_1 , packet1.oil_pressure_1 , packet1.oil_temperature_2 , packet1.oil_pressure_2 , packet1.head1_temperature , packet1.head2_temperature , packet1.turbine_pressure , packet1.fuel_pressure , packet1.exhaust_temperature_1 , packet1.exhaust_temperature_2 , packet1.exhaust_temperature_3 , packet1.exhaust_temperature_4 , packet1.coolant_temperature , packet1.turbine_state_flags , packet1.clutch_state_flags , packet1.frame_pressure , packet1.equipment_state_flags , packet1.rotor_sensors_state_flags );
    mavlink_msg_uvr_engine_low_rate_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("UVR_ENGINE_LOW_RATE") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_UVR_ENGINE_LOW_RATE) != NULL);
#endif
}

static void mavlink_test_uvr_battery(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_UVR_BATTERY >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_uvr_battery_t packet_in = {
        17235,139
    };
    mavlink_uvr_battery_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.voltage = packet_in.voltage;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_UVR_BATTERY_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_UVR_BATTERY_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_uvr_battery_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_uvr_battery_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_uvr_battery_pack(system_id, component_id, &msg , packet1.battery_id , packet1.voltage );
    mavlink_msg_uvr_battery_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_uvr_battery_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.battery_id , packet1.voltage );
    mavlink_msg_uvr_battery_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_uvr_battery_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_uvr_battery_send(MAVLINK_COMM_1 , packet1.battery_id , packet1.voltage );
    mavlink_msg_uvr_battery_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("UVR_BATTERY") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_UVR_BATTERY) != NULL);
#endif
}

static void mavlink_test_uvr_main_board(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_UVR_MAIN_BOARD >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
    ...
    mavlink_uvr_main_board_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.temperature_main_engine = packet_in.temperature_main_engine;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_UVR_MAIN_BOARD_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_UVR_MAIN_BOARD_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_uvr_main_board_encode(system_id, component_id, &msg, &packet1);
...
#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("UVR_MAIN_BOARD") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_UVR_MAIN_BOARD) != NULL);
#endif
}

static void mavlink_test_uvr_ers_board(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_UVR_ERS_BOARD >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_uvr_ers_board_t packet_in = {
        17.0
    };
    mavlink_uvr_ers_board_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.pressure_barometric = packet_in.pressure_barometric;
        
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_UVR_ERS_BOARD_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_UVR_ERS_BOARD_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_uvr_ers_board_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_uvr_ers_board_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_uvr_ers_board_pack(system_id, component_id, &msg , packet1.pressure_barometric );
    mavlink_msg_uvr_ers_board_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_uvr_ers_board_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.pressure_barometric );
    mavlink_msg_uvr_ers_board_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_uvr_ers_board_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_uvr_ers_board_send(MAVLINK_COMM_1 , packet1.pressure_barometric );
    mavlink_msg_uvr_ers_board_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("UVR_ERS_BOARD") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_UVR_ERS_BOARD) != NULL);
#endif
}

static void mavlink_test_uvr_esc_status(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_UVR_ESC_STATUS >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_uvr_esc_status_t packet_in = {
        963497464,45.0,73.0,101.0,963498296,65,132
    };
    mavlink_uvr_esc_status_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_UVR_ESC_STATUS_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_UVR_ESC_STATUS_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_uvr_esc_status_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_uvr_esc_status_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_uvr_esc_status_pack(system_id, component_id, &msg , packet1.error_count , packet1.voltage , packet1.current , packet1.temperature , packet1.rpm , packet1.power_rating_pct , packet1.esc_index );
    mavlink_msg_uvr_esc_status_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_uvr_esc_status_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.error_count , packet1.voltage , packet1.current , packet1.temperature , packet1.rpm , packet1.power_rating_pct , packet1.esc_index );
    mavlink_msg_uvr_esc_status_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_uvr_esc_status_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_uvr_esc_status_send(MAVLINK_COMM_1 , packet1.error_count , packet1.voltage , packet1.current , packet1.temperature , packet1.rpm , packet1.power_rating_pct , packet1.esc_index );
    mavlink_msg_uvr_esc_status_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("UVR_ESC_STATUS") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_UVR_ESC_STATUS) != NULL);
#endif
}

static void mavlink_test_uvr_pid_gov(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_UVR_PID_GOV >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_uvr_pid_gov_t packet_in = {
        17.0,45.0,73.0,101.0,129.0,157.0,185.0,213.0,241.0,113
    };
    mavlink_uvr_pid_gov_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.target = packet_in.target;
        packet1.actual = packet_in.actual;
        packet1.error = packet_in.error;
        packet1.P = packet_in.P;
        packet1.I = packet_in.I;
        packet1.D = packet_in.D;
        packet1.FF = packet_in.FF;
        packet1.out = packet_in.out;
        packet1.raw_error = packet_in.raw_error;
        packet1.governor_active = packet_in.governor_active;
        
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_UVR_PID_GOV_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_UVR_PID_GOV_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_uvr_pid_gov_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_uvr_pid_gov_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_uvr_pid_gov_pack(system_id, component_id, &msg , packet1.target , packet1.actual , packet1.error , packet1.P , packet1.I , packet1.D , packet1.FF , packet1.out , packet1.raw_error , packet1.governor_active );
    mavlink_msg_uvr_pid_gov_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_uvr_pid_gov_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.target , packet1.actual , packet1.error , packet1.P , packet1.I , packet1.D , packet1.FF , packet1.out , packet1.raw_error , packet1.governor_active );
    mavlink_msg_uvr_pid_gov_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_uvr_pid_gov_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_uvr_pid_gov_send(MAVLINK_COMM_1 , packet1.target , packet1.actual , packet1.error , packet1.P , packet1.I , packet1.D , packet1.FF , packet1.out , packet1.raw_error , packet1.governor_active );
    mavlink_msg_uvr_pid_gov_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("UVR_PID_GOV") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_UVR_PID_GOV) != NULL);
#endif
}
...
static void mavlink_test_uh_beyond_m_sensors(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_uh_beyond_m_sensors_t packet_in = {
        17.0,45.0,73.0,101.0,129.0,157.0,185.0,213.0,241.0,269.0,297.0,325.0,353.0,381.0,409.0,20355,20459,20563
    };
    mavlink_uh_beyond_m_sensors_t packet1, packet2;
        ...
        packet1.pressure_frame = packet_in.pressure_frame;
    ...
    mavlink_msg_uh_beyond_m_sensors_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_uh_beyond_m_sensors_pack(system_id, component_id, &msg , packet1.temperature_EG1 , packet1.temperature_EG2 , packet1.temperature_EG3 , packet1.temperature_EG4 , packet1.temperature_CHT1 , packet1.temperature_CHT2 , packet1.temperature_oil , packet1.temperature_coolant , packet1.temperature_gearbox , packet1.pressure_fuel , packet1.pressure_oil , packet1.pressure_manifold , packet1.level_fuel , packet1.pressure_frame , packet1.rotor_rpm , packet1.engine_rpm , packet1.battery_12v , packet1.status_bits );
    mavlink_msg_uh_beyond_m_sensors_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_uh_beyond_m_sensors_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.temperature_EG1 , packet1.temperature_EG2 , packet1.temperature_EG3 , packet1.temperature_EG4 , packet1.temperature_CHT1 , packet1.temperature_CHT2 , packet1.temperature_oil , packet1.temperature_coolant , packet1.temperature_gearbox , packet1.pressure_fuel , packet1.pressure_oil , packet1.pressure_manifold , packet1.level_fuel , packet1.pressure_frame , packet1.rotor_rpm , packet1.engine_rpm , packet1.battery_12v , packet1.status_bits );
    mavlink_msg_uh_beyond_m_sensors_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_uh_beyond_m_sensors_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_uh_beyond_m_sensors_send(MAVLINK_COMM_1 , packet1.temperature_EG1 , packet1.temperature_EG2 , packet1.temperature_EG3 , packet1.temperature_EG4 , packet1.temperature_CHT1 , packet1.temperature_CHT2 , packet1.temperature_oil , packet1.temperature_coolant , packet1.temperature_gearbox , packet1.pressure_fuel , packet1.pressure_oil , packet1.pressure_manifold , packet1.level_fuel , packet1.pressure_frame , packet1.rotor_rpm , packet1.engine_rpm , packet1.battery_12v , packet1.status_bits );
    mavlink_msg_uh_beyond_m_sensors_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
...
static void mavlink_test_uvr_pilot_id(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_UVR_PILOT_ID >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_uvr_pilot_id_t packet_in = {
        5
    };
    mavlink_uvr_pilot_id_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.pilot_id = packet_in.pilot_id;
        
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_UVR_PILOT_ID_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_UVR_PILOT_ID_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_uvr_pilot_id_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_uvr_pilot_id_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_uvr_pilot_id_pack(system_id, component_id, &msg , packet1.pilot_id );
    mavlink_msg_uvr_pilot_id_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_uvr_pilot_id_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.pilot_id );
    mavlink_msg_uvr_pilot_id_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_uvr_pilot_id_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_uvr_pilot_id_send(MAVLINK_COMM_1 , packet1.pilot_id );
    mavlink_msg_uvr_pilot_id_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("UVR_PILOT_ID") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_UVR_PILOT_ID) != NULL);
#endif
}

static void mavlink_test_uvr_generic_data(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_UVR_GENERIC_DATA >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
    ...
    mavlink_uvr_generic_data_t packet1, packet2;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_UVR_GENERIC_DATA_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_UVR_GENERIC_DATA_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_uvr_generic_data_encode(system_id, component_id, &msg, &packet1);
...
#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("UVR_GENERIC_DATA") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_UVR_GENERIC_DATA) != NULL);
#endif
}
...
static void mavlink_test_uh_easa_uas_sn_request(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_uh_easa_uas_sn_request_t packet_in = {
        963497464,17,"FGH","JKLMNOPQRSTUVWXYZAB"
    };
    mavlink_uh_easa_uas_sn_request_t packet1, packet2;
        ...
        mav_array_memcpy(packet1.pincode, packet_in.pincode, sizeof(char)*4);
    ...
    mavlink_msg_uh_easa_uas_sn_request_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_uh_easa_uas_sn_request_pack(system_id, component_id, &msg , packet1.request_id , packet1.cmd , packet1.pincode , packet1.serial_number );
    mavlink_msg_uh_easa_uas_sn_request_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_uh_easa_uas_sn_request_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.request_id , packet1.cmd , packet1.pincode , packet1.serial_number );
    mavlink_msg_uh_easa_uas_sn_request_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_uh_easa_uas_sn_request_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_uh_easa_uas_sn_request_send(MAVLINK_COMM_1 , packet1.request_id , packet1.cmd , packet1.pincode , packet1.serial_number );
    mavlink_msg_uh_easa_uas_sn_request_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
...
static void mavlink_test_ardupilotmega(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_test_uvr_engine_low_rate(system_id, component_id, last_msg);
    mavlink_test_uvr_battery(system_id, component_id, last_msg);
    mavlink_test_uvr_main_board(system_id, component_id, last_msg);
